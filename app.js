...
window.addEventListener("load", () => {
  ...
  document.querySelector("#post-button").addEventListener("click", function () {
    ...
    let dateTi = new Date().getTime();
    const addText = {
      friend: username,
      text: `${textContent} ${hashContent}`,
      feeling: feelContent,
      image: `/Users/user/Desktop/precourse.bacefook-dig/images/${feelContent}.jpg`,
      timestamp: dateTi
    };
    const addTextJSONData = JSON.stringify(addText);
...
function sort(arr) {
  arr.newsfeed.sort(function (a, b) {
